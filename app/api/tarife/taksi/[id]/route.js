...
// PUT request - Taksi tarifesi güncelleme
export async function PUT(request, { params }) {
  try {
    ...
    return NextResponse.json(
      { message: 'Taksi tarifesi güncellendi', data: data[0] },
      { headers: corsHeaders }
    )
  } catch (error) {
...
// DELETE request - Taksi tarifesi silme
export async function DELETE(request, { params }) {
  try {
    ...
    return NextResponse.json(
      { message: 'Taksi tarifesi silindi', data: data[0] },
      { headers: corsHeaders }
    )
  } catch (error) {
    console.error('Server error:', error)
